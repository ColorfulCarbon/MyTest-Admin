  ...
  <div class="login">
    ...
    <el-card shadow='never'>
      <el-form label-width='110px'>
        ...
        <el-form-item label="应用名称:" class="ydd-margin" >
          <el-input v-model="appName"></el-input>
        </el-form-item>

        <el-form-item label="数据API地址:" class="ydd-margin" >
          <el-input v-model="apiUrl"></el-input>
        </el-form-item>

        <el-form-item label="管理后台地址:" class="ydd-margin" >
          <el-input v-model="adminUrl"></el-input>
        </el-form-item>

        <el-form-item label="APP地址:" class="ydd-margin" >
          <el-input v-model="appUrl"></el-input>
        </el-form-item>

        <el-form-item label="ICP备案号:" class="ydd-margin" >
          <el-input v-model="icp"></el-input>
        </el-form-item>

        <el-form-item label="版权声明:" class="ydd-margin">
